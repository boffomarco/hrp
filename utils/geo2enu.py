...
if __name__ == '__main__':
    ...
    x = 59.40777
    y = 17.940777
    lat = 59.406820  # Manually set based on test
    lon = 17.940523 # Manually set based on test
    #xEast, yNorth, zUp =
    print(geodetic_to_enu(x, y, 0, lat, lon, 0))

    print(pm.geodetic2enu(x, y, 0, lat, lon, 0))


    print(geodetic_to_ecef(lat, lon, 0))
