...
class PoseCheckerEuler():

    def __init__(self):
        print("Initialising PoseCheckerEuler")

        rospy.init_node("PoseCheckerEuler", anonymous=True)

        self.pose_Check_pub = rospy.Publisher('PoseCheckEuler', Pose, queue_size=20)
    ...
    def Enc2PoseEuler(self, wheel_encoder): # https://backend.orbit.dtu.dk/ws/portalfiles/portal/5388217/Larsen.pdf
        ...
        delta_y = delta_d * math.sin( self.th )
...
if __name__ == '__main__':
    ...
    try:
        ...
        poseCheckerEuler = PoseCheckerEuler()
